...
sol_otim_P = lm.minimize(Otimizador.obj_model_monod_P, paras, 'leastsq', args=(data, [0, 240], condicoes_iniciais, t_exp))
...
paras_SP.add('umax', value=0.2, min=0.02, max=1.4) #dia-1
...
sol_otim_SP = lm.minimize(Otimizador.obj_model_monod_SP, paras_SP, 'leastsq', args=(data, [0, 240], condicoes_iniciais, t_exp))
