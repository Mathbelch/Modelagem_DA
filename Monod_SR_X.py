...
sol_otim_P = lm.minimize(Otimizador.obj_P_model_monod_sr_x, paras, 'leastsq', args=(data, [0, 240], condicoes_iniciais, t_exp))
...
sol_otim_SP = lm.minimize(Otimizador.obj_SP_model_monod_sr_x, paras, 'leastsq', args=(data, [0, 240], condicoes_iniciais, t_exp), nan_policy='omit')
